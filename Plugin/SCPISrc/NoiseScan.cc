...
int main(int argc, char* argv[])
{
  signal(SIGINT, signalHandler);
	...
	cmd.defineOption( "file", "Config File . Default value: SMUSettings/NoiseScan.xml", ArgvParser::OptionRequiresValue /*| ArgvParser::OptionRequired*/ );
	...
	std::string cHWFile = ( cmd.foundOption( "file" ) ) ? cmd.optionValue( "file" ) : "SMUSettings/NoiseScan.xml";
