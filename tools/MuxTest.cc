		...
		for ( auto cBoard : cShelve->fBoardVector )
		{
			...
			for ( auto cFe : cBoard->fModuleVector )
			{
				...
				for ( auto cCbc : cFe->fCbcVector )
				{
					...
					{
						TString cGraphname = Form( "Fe%d_Cbc%d_%s", cFeId, cCbcId, (TString)(cNames.first) );
...
// 
// 
// void MuxTest::measureSCurves( bool pOffset, int  pTGrpId )
// {
...
// }
// 
// void MuxTest::measureSCurvesBinary( bool pOffset, int  pTGrpId )
// {
// 	// Adaptive Loop to measure SCurves
// 
// 	if ( pOffset ) std::cout << BOLDGREEN << "Measuring SCurves sweeping Channel Offsets ... " << RESET << std::endl;
...
// }
// 
// void MuxTest::initializeSCurves( TString pParameter, uint8_t pValue, int  pTGrpId )
// {
...
// }
// 
// uint32_t MuxTest::fillSCurves( BeBoard* pBoard,  const Event* pEvent, uint8_t pValue, int  pTGrpId, bool pDraw )
// {
...
// }
// 
// void MuxTest::processSCurves( TString pParameter, uint8_t pValue, bool pDraw, int  pTGrpId )
// {
...
// }
// 
// void MuxTest::processSCurvesOffset( TString pParameter, uint8_t pTargetBit, bool pDraw, int pTGrpId )
// {
...
// }
// 
// void MuxTest::findVplus( bool pDraw )
// {
